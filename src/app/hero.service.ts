...
import { trimTrailingNulls, temporaryAllocator } from '@angular/compiler/src/render3/view/util';
...
export class HeroService {
  ...
  private handleError<T>(operation = 'operation', result?: T){
    return (error: any): Observable<T> => {
      ...
      // send the error to remote log on console
      console.error(error);
